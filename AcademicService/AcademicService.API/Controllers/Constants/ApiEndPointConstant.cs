...
public class ApiEndPointConstant
{
    ...
    public static class Submissions
    {
        ...
        public const string SubmissionEndpointByExamId = SubmissionsEndpoint + "/exam/{examId}";
        public const string SubmissionEndpointByExamIdAndExaminerId = SubmissionsEndpoint + "/exam/{examId}/examiner/{examinerId}";
